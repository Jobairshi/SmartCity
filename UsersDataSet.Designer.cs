...
namespace SmartCity {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class UserIdDataTable : global::System.Data.TypedTableBase<UserIdRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserIdRow AddUserIdRow(string Name, string Password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserIdRow FindBynum(int num) {
        ...
        public partial class UserIdRow : global::System.Data.DataRow {
            ...
            public int num {
                get {
                    return ((int)(this[this.tableUserId.numColumn]));
                }
                set {
                    this[this.tableUserId.numColumn] = value;
                }
            }
...
namespace SmartCity.UsersDataSetTableAdapters {
    ...
    public partial class UserIdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserId] WHERE (([num] = @Original_num) AND ([Name] = @Original" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserId] ([Name], [Password]) VALUES (@Name, @Password);\r\nSELEC" +
                "T num, Name, Password FROM UserId WHERE (num = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[UserId] SET [Name] = @Name, [Password] = @Password WHERE (([num] = " +
                "@Original_num) AND ([Name] = @Original_Name) AND ([Password] = @Original_Passwor" +
                "d));\r\nSELECT num, Name, Password FROM UserId WHERE (num = @num)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SmartCity.Properties.Settings.Default.UsersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT num, Name, Password FROM dbo.UserId";
        ...
        public virtual int Fill(UsersDataSet.UserIdDataTable dataTable) {
        ...
        public virtual UsersDataSet.UserIdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UsersDataSet.UserIdDataTable dataTable = new UsersDataSet.UserIdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UsersDataSet.UserIdDataTable dataTable) {
        ...
        public virtual int Delete(int Original_num, string Original_Name, string Original_Password) {
        ...
        public virtual int Update(string Name, string Password, int Original_num, string Original_Name, string Original_Password, int num) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Password, int Original_num, string Original_Name, string Original_Password) {
            return this.Update(Name, Password, Original_num, Original_Name, Original_Password, Original_num);
        }
    }
