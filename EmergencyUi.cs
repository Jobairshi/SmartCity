...
namespace SmartCity
{
    public partial class EmergencyUi : Form
    {
        public EmergencyUi()
        {
            InitializeComponent();
        ...
        private void EmergencyUi_Load(object sender, EventArgs e)
        {
            int count = add();
        ...
        public void Connect_Check(string area,string type)
        {
            string constr;
            SqlConnection conn;
            ...
            sql = "Select area,type,name,phone,link from emer";
        ...
        private void Submit_Click(object sender, EventArgs e)
        {
            ...
            string type = EmerBox.Texts;
            Connect_Check(area,type);
        }
    }
}
